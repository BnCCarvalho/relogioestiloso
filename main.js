...
const sliderMainContainers = Array.from(
  document.querySelectorAll(".slider-main-container")
);
const sliders = Array.from(
  document.querySelectorAll(".slider-main-container .slider-container")
);
const magnifierSliders = Array.from(
  document.querySelectorAll(".slider-magnifier-container .slider-container")
);
